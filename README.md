...
*   [Buy Reefine on Devot:ee](http://devot-ee.com/add-ons/reefine)
*   [View live demo of Reefine](http://www.ralphmedia.co.uk/reefine/demo_basic)
*   [Reefine homepage](http://www.ralphmedia.co.uk/our_work/reefine-expressionengine-add-on)
...
- [Parameters](#parameters)
  ...
  * [channel](#channel)
  * [url](#url)
  * [url\_output](#url_output)
  * [theme](#theme)
  * [method](#method)
  * [author\_id](#author_id)
  * [disable\_search](#disable_search)
  * [fix\_pagination](#fix_pagination)
  * [site](#site)
  * [search:_field name_](#search_field-name_)
  * [category](#category)
  * [category\_url](#category_url)
  * [fixed\_order](#fixed_order)
  * [show\_expired](#show_expired)
  * [show\_future\_entries](#show_future_entries)
  * [status](#status)
  * [filter:fields](#filterfields)
  * [filter:_filter group name_](#filter_filter-group-name_)
  * [filter:_filter group_:type](#filter_filter-group_type)
    + [filter:_filter group_:type="list"](#filter_filter-group_typelist)
    + [filter:_filter group_:type="search"](#filter_filter-group_typesearch)
    + [filter:_filter group_:type="number\_range"](#filter_filter-group_typenumber_range)
    + [filter:_filter group_:type="month\_list"](#filter_filter-group_typemonth_list)
    + [filter:_filter group_:type="tree"](#filter_filter-group_typetree)
  * [filter:_filter group_:fields](#filter_filter-group_fields)
  * [filter:_filter group_:label](#filter_filter-group_label)
  * [filter:_filter group_:show\_empty\_filters](#filter_filter-group_show_empty_filters)
  * [filter:_filter group_:custom\_titles](#filter_filter-group_custom_titles)
  * [filter:_filter group_:custom\_values](#filter_filter-group_custom_values)
  * [filter:_filter group_:default](#filter_filter-group_default)
  * [filter:_filter group_:delimiter](#filter_filter-group_delimiter)
  ...
  * [filter:_filter group_:category\_group](#filter_filter-group_category_group)
  * [filter:_filter group_:show\_separate\_only](#filter_filter-group_show_separate_only)
- [Single Variables](#single-variables)
  * [{total\_active\_filters}](#total_active_filters)
  * [{total\_entries}](#total_entries)
  * [{querystring}](#querystring)
- [{entries} Variable Pair](#entries-variable-pair)
  * [{entries} » {entry\_ids}](#entries-%C2%BB-entry_ids)
  * [{entries} » {total\_entries}](#entries-%C2%BB-total_entries)
- [{list\_groups} Variable Pair](#list_groups-variable-pair)
  * [{list\_groups} » {group\_name}](#list_groups-%C2%BB-group_name)
  * [{list\_groups} » {label}](#list_groups-%C2%BB-label)
  * [{list\_groups} » {type}](#list_groups-%C2%BB-type)
  * [{list\_groups} » {total\_filters}](#list_groups-%C2%BB-total_filters)
  * [{list\_groups} » {active\_filters}](#list_groups-%C2%BB-active_filters)
  * [{list\_groups} » {matching\_filters}](#list_groups-%C2%BB-matching_filters)
  * [{list\_groups} » {clear\_url}](#list_groups-%C2%BB-clear_url)
- [{list\_groups} » {filters} Variable Pair](#list_groups-%C2%BB-filters-variable-pair)
  * [{list\_groups} » {filters} » {filter\_id}](#list_groups-%C2%BB-filters-%C2%BB-filter_id)
  * [{list\_groups} » {filters} » {filter\_value}](#list_groups-%C2%BB-filters-%C2%BB-filter_value)
  * [{list\_groups} » {filters} » {filter\_title}](#list_groups-%C2%BB-filters-%C2%BB-filter_title)
  * [{list\_groups} » {filters} » {url}](#list_groups-%C2%BB-filters-%C2%BB-url)
  * [{list\_groups} » {filters} » {filter\_quantity}](#list_groups-%C2%BB-filters-%C2%BB-filter_quantity)
  * [{list\_groups} » {filters} » {filter\_active}](#list_groups-%C2%BB-filters-%C2%BB-filter_active)
  * [{list\_groups} » {filters} » {filter\_active\_class}](#list_groups-%C2%BB-filters-%C2%BB-filter_active_class)
  * [{list\_groups} » {filters} » {filter\_active\_boolean}](#list_groups-%C2%BB-filters-%C2%BB-filter_active_boolean)
- [{tree\_groups} Variable Pair](#tree_groups-variable-pair)
  * [{tree\_groups} » {filters}](#tree_groups-%C2%BB-filters)
  * [{tree\_groups} » {filters} » {has\_active\_subfilters}](#tree_groups-%C2%BB-filters-%C2%BB-has_active_subfilters)
  * [{tree\_groups} » {filters} » {has\_active\_subfilters\_class}](#tree_groups-%C2%BB-filters-%C2%BB-has_active_subfilters_class)
  * [{tree\_groups} » {filters} » {subfilters\_1}](#tree_groups-%C2%BB-filters-%C2%BB-subfilters_1)
  * [{tree\_groups} » {filters} » {subfilters\_1} » {subfilters\_2}](#tree_groups-%C2%BB-filters-%C2%BB-subfilters_1-%C2%BB-subfilters_2)
  * [{tree\_groups} » {filters} » {subfilters\_1} » {subfilters\_2} » {subfilters\_3} ...](#tree_groups-%C2%BB-filters-%C2%BB-subfilters_1-%C2%BB-subfilters_2-%C2%BB-subfilters_3-)
- [{number\_range\_groups} Variable Pair](#number_range_groups-variable-pair)
  * [{number\_range\_groups} » {filters} » {filter\_min}](#number_range_groups-%C2%BB-filters-%C2%BB-filter_min)
  * [{number\_range\_groups} » {filters} » {filter\_max}](#number_range_groups-%C2%BB-filters-%C2%BB-filter_max)
  * [{number\_range\_groups} » {filters} » {filter\_min\_value}](#number_range_groups-%C2%BB-filters-%C2%BB-filter_min_value)
  * [{number\_range\_groups} » {filters} » {filter\_max\_value}](#number_range_groups-%C2%BB-filters-%C2%BB-filter_max_value)
- [{search\_groups} Variable Pair](#search_groups-variable-pair)
- [{active\_groups} Variable Pair](#active_groups-variable-pair)
- [{filter\_groups} Variable Pair](#filter_groups-variable-pair)
...
- [Code Samples](#code-samples)
  ...
  * [Example with form and month\_list](#example-with-form-and-month_list)
